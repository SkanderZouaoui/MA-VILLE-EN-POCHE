 ...
 */
final class Version20210714141132 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD vetement_id INT DEFAULT NULL, ADD vacance_id INT DEFAULT NULL, ADD culture_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP vetement_id, DROP vacance_id, DROP culture_id');
    }
}
