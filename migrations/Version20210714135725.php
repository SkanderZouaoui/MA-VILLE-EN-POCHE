 ...
 */
final class Version20210714135725 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE cafe_id cafe_id INT DEFAULT NULL, CHANGE sport_id sport_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE cafe_id cafe_id INT NOT NULL, CHANGE sport_id sport_id INT NOT NULL');
    }
}
