 ...
 */
final class Version20210709142552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cafe ADD latitude DOUBLE PRECISION NOT NULL, ADD longitude VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cafe DROP latitude, DROP longitude');
